MODULE par_bling
   ...
   INTEGER, PUBLIC, PARAMETER ::   jp_bling     =  5       !: number of PTS tracers
   INTEGER, PUBLIC, PARAMETER ::   jp_bling_2d  =  4       !: additional 2d output arrays. If not 1
   INTEGER, PUBLIC, PARAMETER ::   jp_bling_3d  =  27      !: additional 3d output arrays. If not 1
   ...
   INTEGER, PUBLIC, PARAMETER ::   jpine_bling = jp_lm + 5     !: Inert tracer
